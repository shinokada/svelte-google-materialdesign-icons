...
>
  ...
  {:else if variation === 'two-tone'}
    <path
      ...
      opacity=".3"
    /><path d="M12 5h9v6.68c.75.36 1.43.84 2 1.42V3H10v1.97l2 1.43V5z" /><path
    ...
    /><path d="m8 8.46-5 3.57V19h2v-5h6v4c0-1.91.76-3.63 2-4.89v-1.08L8 8.46z" opacity=".3" /><path
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = 'add home work';
-->
