...
>
  {#if variation === 'outlined'}
    <path d="M14 7h-4c-1.1 0-2 .9-2 2v6h2.5v7h3v-7H16V9c0-1.1-.9-2-2-2z" /><circle
      cx="12"
      cy="4"
      r="2"
    />
  ...
  {:else if variation === 'sharp'}
    <path d="M16 7H8v8h2.5v7h3v-7H16z" /><circle cx="12" cy="4" r="2" />
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = 'man 2';
-->
