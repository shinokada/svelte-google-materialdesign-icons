...
>
  {#if variation === 'outlined'}
    <path d="M6 15h6v2H6zm6-8h6v2h-6zm-3 4h6v2H9z" /><path
  ...
  {:else if variation === 'two-tone'}
    <path d="M5 19h14V5H5v14zm7-12h6v2h-6V7zm-3 4h6v2H9v-2zm-3 4h6v2H6v-2z" opacity=".3" /><path
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = 'view timeline';
-->
