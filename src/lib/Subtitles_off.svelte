...
>
  {#if variation === 'outlined'}
    <path d="M20 4H6.83l2 2H20v11.17l1.76 1.76c.15-.28.24-.59.24-.93V6c0-1.1-.9-2-2-2z" /><path
  ...
  {:else if variation === 'two-tone'}
    <path
      ...
      opacity=".3"
    /><path d="M18 10h-5.17l2 2H18z" /><path
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = 'subtitles off';
-->
