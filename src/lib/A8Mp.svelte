...
>
  ...
  {:else if variation === 'round'}
    <path d="M15 14h1.5v1.5H15z" /><path
  ...
  {:else if variation === 'sharp'}
    <path d="M15 14h1.5v1.5H15zm-3.5-7.5H13V8h-1.5z" /><path
  ...
  {:else if variation === 'two-tone'}
    <path d="M15 14h1.5v1.5H15zm-3.5-7.5H13V8h-1.5zm0 2.5H13v1.5h-1.5z" opacity=".3" /><path
