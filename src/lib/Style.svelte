...
>
  {#if variation === 'outlined'}
    ...
    /><circle cx="11" cy="9" r="1" /><path d="M5.88 19.75c0 1.1.9 2 2 2h1.45l-3.45-8.34v6.34z" />
  ...
  {:else if variation === 'two-tone'}
    ...
    /><circle cx="11" cy="9" r="1" /><path d="m9.33 21.75-3.45-8.34v6.34c0 1.1.9 2 2 2h1.45z" />
  {/if}
</svg>
