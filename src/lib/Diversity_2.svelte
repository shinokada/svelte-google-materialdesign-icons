<script lang="ts">
  ...
  export let ariaLabel = 'diversity 2';
</script>
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = 'diversity 2';
-->
