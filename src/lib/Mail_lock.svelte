...
>
  ...
  {:else if variation === 'sharp'}
    <path d="M22 9.97V4H2.01L2 20h14v-5.03c0-2.76 2.24-5 5-5h1zM20 8l-8 5-8-5V6l8 5 8-5v2z" /><path
  ...
  {:else if variation === 'two-tone'}
    <path d="M20 6H4l8 5z" opacity=".3" /><path
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = 'mail lock';
-->
