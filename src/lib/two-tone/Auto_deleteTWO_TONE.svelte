<script>
	...
	export let ariaLabel = 'auto_delete';
</script>
...
<svg
	...
	viewBox="0 0 24 24"
	><path d="M12 7H4v10h5.08c-.05-.33-.08-.66-.08-1 0-2.38 1.19-4.47 3-5.74V7z" opacity=".3" /><path
	...
	/><path d="M16.5 12H15v5l3.6 2.1.8-1.2-2.9-1.7z" /></svg
>
