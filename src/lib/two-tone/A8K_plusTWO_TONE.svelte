...
<svg
	...
	viewBox="0 0 24 24"
	><path d="M7.5 12.5h1V14h-1zm0-2.5h1v1.5h-1z" opacity=".3" /><path
	...
	/><path d="M12.5 12.75 14.25 15H16l-2.25-3L16 9h-1.75l-1.75 2.25V9H11v6h1.5z" /></svg
>
