<script>
	...
	export let ariaLabel = 'spatial_audio_off';
</script>
...
<svg
	...
	><path
		...
		opacity=".3"
	/><circle cx="10" cy="9" r="2" opacity=".3" /><path
	...
	/><path d="M17.54 10.9a5.003 5.003 0 0 0 0-7.07l-1.41 1.41a3 3 0 0 1 0 4.24l1.41 1.42z" /></svg
>
