...
>
  ...
  {:else if variation === 'round'}
    <path d="M22 4c0-1.1-.9-2-2-2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h9v-7c0-.55.45-1 1-1h6V4z" /><path
  ...
  {:else if variation === 'two-tone'}
    <path d="M4 4v13.17L5.17 16H15v-6h5V4z" opacity=".3" /><path
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = 'quickreply';
-->
