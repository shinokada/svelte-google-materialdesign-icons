...
>
  ...
  {:else if variation === 'round'}
    <path d="M13.5 9H15v1.5h-1.5z" /><path
  ...
  {:else if variation === 'sharp'}
    <path d="M13.5 9H15v1.5h-1.5zm0-2.5H15V8h-1.5z" /><path
  ...
  {:else if variation === 'two-tone'}
    <path d="M13.5 6.5H15V8h-1.5zm0 2.5H15v1.5h-1.5z" opacity=".3" /><path
      ...
      opacity=".3"
    /><path d="M15 14h1.5v1.5H15z" opacity=".3" /><path
      d="M7.5 14h1v3H10v-3h1v4.5h1.5v-5c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1v5h1.5V14zm6 4.5H15V17h2c.55 0 1-.45 1-1v-2.5c0-.55-.45-1-1-1h-3.5v6zM15 14h1.5v1.5H15V14z"
    /><path
      d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14z"
    /><path
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = '18mp';
-->
