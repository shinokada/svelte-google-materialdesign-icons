<script lang="ts">
  ...
  let svground = '<path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2z"/>';
  let svgsharp = '<path d="M3 3h18v18H3z"/>';
  let svgtwotone = '<path d="M5 5h14v14H5z" opacity=".3"/><path d="M3 3v18h18V3H3zm16 16H5V5h14v14z"/>';
  switch (variation) {
    case "filled":
      svgpath = svgfilled;
      break;
