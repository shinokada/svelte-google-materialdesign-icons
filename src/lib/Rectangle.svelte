<script lang="ts">
  ...
  let svground = '<path d="M2 6v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2z"/>';
  let svgsharp = '<path d="M2 4h20v16H2z"/>';
  let svgtwotone = '<path d="M4 6h16v12H4z" opacity=".3"/><path d="M2 4v16h20V4H2zm18 14H4V6h16v12z"/>';
  switch (variation) {
    case "filled":
      svgpath = svgfilled;
      break;
