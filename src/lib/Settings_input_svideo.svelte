...
>
  ...
  {:else if variation === 'round'}
    ...
    /><circle cx="7.5" cy="11.5" r="1.5" /><circle cx="16.5" cy="11.5" r="1.5" /><circle
      cx="9"
      cy="16"
      r="1.5"
    /><circle cx="15" cy="16" r="1.5" /><path
  ...
  {:else if variation === 'two-tone'}
    ...
    /><circle cx="15.5" cy="16.5" r="1.5" /><circle cx="17.5" cy="11.5" r="1.5" /><path
    ...
    /><circle cx="6.5" cy="11.5" r="1.5" /><circle cx="8.5" cy="16.5" r="1.5" />
  {/if}
</svg>
...
@prop export let variation: 'filled' | 'outlined' | 'round' | 'sharp' | 'two-tone' =
    ctx.variation || 'outlined';
@prop export let ariaLabel = 'settings input svideo';
-->
