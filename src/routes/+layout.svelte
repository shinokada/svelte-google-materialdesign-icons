...
<MetaTags
  title="{title}"
  description="Google Materialdesign Icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-google-materialdesign-icons.vercel.app/',
    title: "Svelte Google Materialdesign Icons",
    description: "Google Materialdesign Icon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-google-materialdesign-icons', width: 1200, height: 630, alt: "Svelte Google Materialdesign Icons" }],
    site_name: 'Svelte Google Materialdesign Icons'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: "Svelte Google Materialdesign Icons",
    description: "Google Materialdesign Icon set for Svelte",
    image:'https://open-graph-vercel.vercel.app/api/svelte-google-materialdesign-icons',
    imageAlt: "Svelte Google Materialdesign Icons"
  }} />
...
<header class="flex-none w-full mx-auto bg-white dark:bg-slate-950">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-slate-950 ">
    ...
    <NavUl {hidden} {divClass} {ulClass} on:click={() => setTimeout(toggle, 1)} 
      ...
      <NavLi class="lg:px-2 lg:mb-0" active={activeUrl === '/filled'} href="/filled">Filled</NavLi>
      <NavLi class="lg:px-2 lg:mb-0" active={activeUrl === '/outlined'} href="/outlined">Outlined</NavLi>
      <NavLi class="lg:px-2 lg:mb-0" active={activeUrl === '/sharp'} href="/sharp">Sharp</NavLi>
      <NavLi class="lg:px-2 lg:mb-0" active={activeUrl === '/two-tones'} href="/two-tones">Two tones</NavLi>
      <NavLi class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-google-materialdesign-icons">GitHub</NavLi>
...
<Footer footerType="logo" class="dark:bg-slate-950">
  <div class="sm:flex sm:items-center sm:justify-between">
    <FooterBrand
    href="https://svelte-google-materialdesign-icons.vercel.app/"
    name="Svelte Google Materialdesign Icons" classSpan="text-primary-700 dark:text-primary-500"
  />
  <FooterLinkGroup ulClass="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
    <FooterLink href="/filled">Filled</FooterLink>
    <FooterLink href="/outlined">Outlined</FooterLink>
    <FooterLink href="/sharp">Sharp</FooterLink>
    <FooterLink href="/two-tone">Two tone</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-google-materialdesign-icons/blob/main/LICENSE">Licensing</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-google-materialdesign-icons/">GitHub</FooterLink>
  </FooterLinkGroup>
  </div>
</Footer>
