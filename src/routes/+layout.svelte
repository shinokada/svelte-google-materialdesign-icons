...
<header class="flex-none w-full mx-auto bg-white dark:bg-slate-950">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-slate-950 ">
    ...
    <NavUl
      ...
      activeClass="md:!pl-3 md:!py-2 lg:!pl-0 lg:text-gray-700 text-white dark:text-white bg-primary-700 lg:bg-transparent dark:bg-primary-600 lg:dark:bg-transparent cursor-default"
    >
