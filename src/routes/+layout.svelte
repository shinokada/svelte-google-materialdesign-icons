<script>
  ...
  let ulClass = 'flex flex-col py-3 my-4 lg:flex-row lg:my-0 text-sm font-medium gap-4 lg:bg-white lg:border-0';
</script>
...
<MetaTags
  ...
  openGraph={{
    ...
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-google-materialdesign-icons',
        width: 1200,
        height: 630,
        alt: 'Svelte Google Materialdesign Icons'
      }
    ],
...
<header class="flex-none w-full mx-auto bg-white dark:bg-slate-950">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-slate-950 ">
    ...
    <NavUl
      ...
      activeClass="md:!pl-3 md:!py-2 lg:!pl-0 lg:text-primary-700 text-white dark:text-white bg-primary-700 lg:bg-transparent dark:bg-primary-600 lg:dark:bg-transparent cursor-default"
    >
